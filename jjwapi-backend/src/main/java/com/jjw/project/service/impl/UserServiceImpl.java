...
import static com.jjw.project.constant.UserConstant.ADMIN_ROLE;
import static com.jjw.project.constant.UserConstant.USER_LOGIN_STATE;
...
//    }
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        String secretKey = DigestUtils.md5DigestAsHex((SALT + userAccount).getBytes());
